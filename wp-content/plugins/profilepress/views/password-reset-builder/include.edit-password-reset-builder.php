...
if (!is_null(PROFILEPRESS_sql::check_if_builder_is_widget($password_reset_id, 'password_reset'))) {
    $make_widget = 'yes';
} else {
    $make_widget = 'no';
}
...
<a class="button-secondary" href="?page=<?php echo PASSWORD_RESET_BUILDER_SETTINGS_PAGE_SLUG; ?>"
   title="<?php _e('Back to Catalog', 'profilepress'); ?>"><?php _e('Back to Catalog', 'profilepress'); ?></a>
                            ...
                            <table class="form-table">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <p class="description">This is the internal title of your<strong>Password Reset
                        ...
                        <div class="inside">
                            <table class="form-table">
                                <tr>
                                    <th scope="row"></th>
                                    <td>
                                        <?php pp_display_revisions('password_reset', $password_reset_id); ?>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div class="inside">
                            <table class="form-table">
                                <tr>
                                    ...
                                    <td>
                                        <input type="checkbox" name="prb_make_widget" id="make-login-widget" value="yes" <?php checked('yes',
                                            $make_widget); ?> />
                                        <label for="make-login-widget"><strong><?php _e('Make this a Widget',
                                                    'profilepress'); ?></strong></label>

                                        <p class="description">Make this "Password Reset" available as a
