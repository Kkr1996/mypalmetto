                        ...
                        <div class="inside">
                            <table class="form-table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <textarea name="prb_success_password_reset" id="message_success"><?php echo isset($_POST['prb_success_password_reset']) ? $_POST['prb_success_password_reset'] : __('Check your e-mail for further instruction.', 'profilepress'); ?></textarea>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="checkbox" name="prb_make_widget" id="make-login-widget" value="yes" <?php checked('yes',
                                            stripslashes(@$_POST['prb_make_widget'])); ?> />
