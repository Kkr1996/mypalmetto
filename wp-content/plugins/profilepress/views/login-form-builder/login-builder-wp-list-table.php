...
class Login_Builder_List_Table extends WP_List_Table
{
    ...
    function no_items()
    {
        _e('No Login Form Available.', 'profilepress');
    }
...
// Send final sort direction to usort
    ...
    function column_title($item)
    {
        ...
        $actions = array(
            'edit' => sprintf('<a href="?page=%s&action=%s&login=%s&_wpnonce=%s">' . __('Edit', 'profilepress') . '</a>', esc_attr($_REQUEST['page']), 'edit', absint($item['id']), $nonce_edit),
            'clone' => sprintf('<a href="?page=%s&action=%s&login=%s&_wpnonce=%s">' . __('Clone', 'profilepress') . '</a>', esc_attr($_REQUEST['page']), 'clone', absint($item['id']), $nonce_clone),
            'delete' => sprintf('<a href="javascript:pp_del_login(\'%s\',\'%s\',\'%s\',\'%s\')">' . __('Delete', 'profilepress') . '</a>', $_REQUEST['page'], 'delete', esc_attr($item['id']), $nonce_delete),
        );
    ...
    function process_bulk_action()
    {
        ...
        if ('delete' === $this->current_action()) {
            ...
            PROFILEPRESS_sql::sql_delete_login_builder($id);
        ...
        if ('clone' === $this->current_action()) {
            ...
            $clone_data = PROFILEPRESS_sql::get_login_builder_data($id);
