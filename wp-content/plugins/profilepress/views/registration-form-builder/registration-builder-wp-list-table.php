...
// Send final sort direction to usort
    ...
    function column_title($item)
    {
        ...
        $actions = array(
            'edit' => sprintf('<a href="?page=%s&action=%s&registration=%s&_wpnonce=%s">%s</a>', esc_attr($_REQUEST['page']), 'edit', absint($item['id']), $nonce_edit, __('Edit', 'profilepress')),
            'clone' => sprintf('<a href="?page=%s&action=%s&registration=%s&_wpnonce=%s">%s</a>', esc_attr($_REQUEST['page']), 'clone', absint($item['id']), $nonce_clone, __('Clone', 'profilepress')),
            'delete' => sprintf('<a href="javascript:pp_del_registration(\'%s\',\'%s\',\'%d\',\'%s\')">%s</a>', $_REQUEST['page'], 'delete', esc_attr($item['id']), $nonce_delete, __('Delete', 'profilepress')),
        );
    ...
    function process_bulk_action()
    {
        if ('clone' === $this->current_action()) {
            ...
            $clone_data = PROFILEPRESS_sql::get_registration_builder_data($id);
        ...
        if ('delete' === $this->current_action()) {
            ...
            PROFILEPRESS_sql::sql_delete_registration_builder($id);
