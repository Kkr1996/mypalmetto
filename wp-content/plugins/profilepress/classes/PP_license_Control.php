...
class PP_license_Control
{
     ...
     */
    protected $store_url = 'https://profilepress.net';
     ...
     */
    protected $plugin_author = 'Collins Agbonghama';
    ...
    public function activate_license()
    {
        ...
        if (is_wp_error($response) || 200 !== wp_remote_retrieve_response_code($response)) {
            ...
            if (is_wp_error($response)) {
                ...
                $error = __('License validation error. Please try again', 'profilepress');
            }
    ...
    public function check_license()
    {
        ...
        // Call the custom API.
        $response = wp_remote_post(PP_STORE_URL, array('timeout' => 15, 'sslverify' => false, 'body' => $api_params));
