...
class ProfilePress_Login_Auth
{
    ...
    public static function credentials_validation($id = null, $redirect = null)
    {
        ...
        // catch all social login errors caught by the global func below.
        /** @see connectors.php */
        ...
        if (isset($_POST[$submit_name])) {
            ...
            $login_status = self::login_auth($username, $password, $remember_login, $id, $redirect);
     ...
     * @return null|string
     */
    public static function login_auth($username, $password, $remember_login = 'true', $login_form_id = null, $redirect = '')
    {
        ...
        if (is_wp_error($user) && ($user->get_error_code())) {
            ...
            $login_redirection = apply_filters('pp_login_redirect', $login_redirect, $login_form_id, $user);
